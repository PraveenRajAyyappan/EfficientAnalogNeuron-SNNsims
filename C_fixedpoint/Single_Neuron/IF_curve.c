...
int main() {
  ...
  float dt     = 0.000001*1000; // Units (ms)
  int   NSteps = 12e6;  // Total Number of steps to take in the simulation
  int PulseStartIdx = 1e6;
  ...
  for(int a=45; a<161; a=a+10){
    int PulseHeight = fi(a,8); // In pA
    // Open a file for writing
    sprintf(filename, "Vmem_Iin_%d.txt", a);
    FILE *fptr;
